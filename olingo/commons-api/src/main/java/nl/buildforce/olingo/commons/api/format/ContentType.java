...
public final class ContentType {
  ...
  public static final ContentType APPLICATION_HTTP = new ContentType(APPLICATION, "http");
  ...
  public boolean equals(Object obj) {
    ...
    if (!mainType.equals(that.mainType) || !subtype.equals(that.subtype)) return false;
  ...
  public int hashCode() {
    ...
    return 31 * result + parameters.hashCode();
  }
  ...
  public String toString() {
    ...
    sb.append(mainType).append(TypeUtil.TYPE_SUBTYPE_SEPARATOR).append(subtype);
