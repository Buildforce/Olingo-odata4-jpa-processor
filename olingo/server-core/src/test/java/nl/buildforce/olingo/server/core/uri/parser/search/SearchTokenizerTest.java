...
import static nl.buildforce.olingo.server.core.uri.parser.search.SearchQueryToken.Token.AND;
import static nl.buildforce.olingo.server.core.uri.parser.search.SearchQueryToken.Token.CLOSE;
import static nl.buildforce.olingo.server.core.uri.parser.search.SearchQueryToken.Token.NOT;
import static nl.buildforce.olingo.server.core.uri.parser.search.SearchQueryToken.Token.OPEN;
import static nl.buildforce.olingo.server.core.uri.parser.search.SearchQueryToken.Token.OR;
import static nl.buildforce.olingo.server.core.uri.parser.search.SearchQueryToken.Token.PHRASE;
import static nl.buildforce.olingo.server.core.uri.parser.search.SearchQueryToken.Token.WORD;
