 ...
 * under the License.
 */
package nl.buildforce.olingo.server.api.debug;
...
public class DefaultDebugSupport implements DebugSupport {
  ...
  public ODataResponse createDebugResponse(String debugFormat, DebugInformation debugInfo) {
    ...
    if (ODATA_DEBUG_JSON.equalsIgnoreCase(debugFormat)
        || ODATA_DEBUG_HTML.equalsIgnoreCase(debugFormat)
        || ODATA_DEBUG_DOWNLOAD.equalsIgnoreCase(debugFormat)) {
