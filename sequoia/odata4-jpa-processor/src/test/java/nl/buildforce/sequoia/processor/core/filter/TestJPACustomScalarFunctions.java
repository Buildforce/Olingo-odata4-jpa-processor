...
public class TestJPACustomScalarFunctions {
  ...
  public void testFilterOnFunction() throws IOException, ODataException {
    ...
    IntegrationTestHelper helper = new IntegrationTestHelper(emf,
        "AdministrativeDivisions?$filter=nl.buildforce.sequoia.PopulationDensity(Area=$it/Area,Population=$it/Population) gt 1");
  ...
  public void testFilterOnFunctionAndProperty() throws IOException, ODataException {
    ...
    IntegrationTestHelper helper = new IntegrationTestHelper(emf,
        "AdministrativeDivisions?$filter=nl.buildforce.sequoia.PopulationDensity(Area=$it/Area,Population=$it/Population)  mul 1000000 gt 1000 and ParentDivisionCode eq 'BE255'&orderBy=DivisionCode)");
    helper.assertStatus(HttpStatusCode.OK.getStatusCode());
  ...
  public void testFilterOnFunctionAndMultiply() throws IOException, ODataException {
    ...
    IntegrationTestHelper helper = new IntegrationTestHelper(emf,
        "AdministrativeDivisions?$filter=nl.buildforce.sequoia.PopulationDensity(Area=Area,Population=Population)  mul 1000000 gt 100");
    helper.assertStatus(HttpStatusCode.OK.getStatusCode());
  ...
  public void testFilterOnFunctionWithFixedValue() throws IOException, ODataException {
    ...
    IntegrationTestHelper helper = new IntegrationTestHelper(emf,
        "AdministrativeDivisions?$filter=nl.buildforce.sequoia.PopulationDensity(Area=13079087,Population=$it/Population)  mul 1000000 gt 1000");
    helper.assertStatus(HttpStatusCode.OK.getStatusCode());
  ...
  public void testFilterOnFunctionCommuteValue() throws IOException, ODataException {
    ...
    IntegrationTestHelper helper = new IntegrationTestHelper(emf,
        "AdministrativeDivisions?$filter=nl.buildforce.sequoia.PopulationDensity(Area=Area div 1000000,Population=Population) gt 1000");
    helper.assertStatus(HttpStatusCode.OK.getStatusCode());
  ...
  public void testFilterOnFunctionMixParamOrder() throws IOException, ODataException {
    ...
    IntegrationTestHelper helper = new IntegrationTestHelper(emf,
        "AdministrativeDivisions?$filter=nl.buildforce.sequoia.PopulationDensity(Population=Population,Area=Area) mul 1000000 gt 1000");
    helper.assertStatus(HttpStatusCode.OK.getStatusCode());
