...
final class JPAUnaryBooleanOperatorImp implements JPAUnaryBooleanOperator {
   ...
   * @see nl.buildforce.sequoia.processor.core.filter.JPAUnaryBooleanOperator#get()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.processor.core.filter.JPAUnaryBooleanOperator#getLeft()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.processor.core.filter.JPAUnaryBooleanOperator#getOperator()
   */
  @Override
