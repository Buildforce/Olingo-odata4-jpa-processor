...
class JPABooleanOperatorImp implements JPABooleanOperator {
   ...
   * @see nl.buildforce.sequoia.processor.core.filter.JPABooleanOperator#get()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.processor.core.filter.JPABooleanOperator#getOperator()
   */
   ...
   * @see nl.buildforce.sequoia.processor.core.filter.JPABooleanOperator#getLeft()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see nl.buildforce.sequoia.processor.core.filter.JPABooleanOperator#getRight()
   */
  @Override
