...
class JPAArithmeticOperatorImp implements JPAArithmeticOperator {
   ...
   * (non-Javadoc)
   *
   * @see nl.buildforce.sequoia.processor.core.filter.JPAArithmeticOperator#get()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see nl.buildforce.sequoia.processor.core.filter.JPAArithmeticOperator#getOperator()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see nl.buildforce.sequoia.processor.core.filter.JPAArithmeticOperator#getRight()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see nl.buildforce.sequoia.processor.core.filter.JPAArithmeticOperator#getLeft(javax.persistence.criteria.
   * CriteriaBuilder)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see nl.buildforce.sequoia.processor.core.filter.JPAArithmeticOperator#getRightAsNumber(javax.persistence.criteria.
   * CriteriaBuilder)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see nl.buildforce.sequoia.processor.core.filter.JPAArithmeticOperator#getRightAsExpression()
   */
  @Override
  @SuppressWarnings("unchecked")
   ...
   * (non-Javadoc)
   *
   * @see nl.buildforce.sequoia.processor.core.filter.JPAArithmeticOperator#getLeftAsIntExpression()
   */
  @Override
  @SuppressWarnings("unchecked")
   ...
   * (non-Javadoc)
   *
   * @see nl.buildforce.sequoia.processor.core.filter.JPAArithmeticOperator#getRightAsIntExpression()
   */
  @Override
  @SuppressWarnings("unchecked")
