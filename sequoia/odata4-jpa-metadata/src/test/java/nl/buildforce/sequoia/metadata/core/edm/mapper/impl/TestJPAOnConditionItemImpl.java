...
public class TestJPAOnConditionItemImpl {
  ...
  public void checkThrowsExceptionOnMissingLeft() {
    ...
    Assertions.assertEquals(ODataJPAModelException.MessageKeys.ON_LEFT_ATTRIBUTE_NULL.getKey(), act.getId());
  }
  ...
  public void checkThrowsExceptionOnMissingRight() {
    ...
    Assertions.assertEquals(ODataJPAModelException.MessageKeys.ON_RIGHT_ATTRIBUTE_NULL.getKey(), act.getId());
  }
