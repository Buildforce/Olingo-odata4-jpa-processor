...
public class TestAnnotationPOJO {
  ...
  public void TestSimpleXMLConverted() throws IOException {
    ...
    String terms = "<edmx:Edmx xmlns:edmx=\"https://docs.oasis-open.org/odata/ns/edmx\" Version=\"4.0\">"
        + "<edmx:Reference Uri=\"http://docs.oasis-open.org/odata/odata/v4.0/os/vocabularies/Org.OData.Core.V1.xml\">"
        + "<edmx:Include Alias=\"Core\" Namespace=\"Org.OData.Core.V1\" />"
        + "</edmx:Reference>"
        + "<edmx:DataServices>"
        + "<Schema xmlns=\"https://docs.oasis-open.org/odata/ns/edm\" Namespace=\"Org.OData.Measures.V1\" Alias=\"Measures\"> "
