...
import nl.buildforce.sequoia.metadata.core.edm.mapper.annotation.SchemaReader;
  ...
  public IntermediateReferenceAccess addReference(final String uri, final String path) throws ODataJPAModelException {
    ...
    if (path != null && !path.isEmpty()) {
      try {
        ...
        throw new ODataJPAModelException(ODataJPAModelException.MessageKeys.ANNOTATION_PARSE_ERROR, e, path, e.getMessage());
      }
    }
