...
import nl.buildforce.sequoia.metadata.core.edm.mapper.api.JPAJoinTable;
...
final class JPAAssociationPathImpl implements JPAAssociationPath {
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAAssociationPath#getAlias()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAAssociationPath#getJoinColumnsList()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAAssociationPath#getLeaf()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAAssociationPath#getPath()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAAssociationPath#getSourceType()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAAssociationPath#getTargetType()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAAssociationPath#isCollection()
   */
  @Override
