...
//      Determine referential constraint
  ...
  private void checkConsistency() throws ODataJPAModelException {
    ...
    if (jpaProtectedBy != null) {
      ...
      throw new ODataJPAModelException(ODataJPAModelException.MessageKeys.NOT_SUPPORTED_PROTECTED_NAVIGATION, this.sourceType.getTypeClass()
    ...
    if (jpaFieldGroups != null) {
      throw new ODataJPAModelException(ODataJPAModelException.MessageKeys.NOT_SUPPORTED_NAVIGATION_PART_OF_GROUP,
