...
final class JPAPathImpl implements JPAPath {
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAPath#getAlias()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAPath#getDBFieldName()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAPath#getLeaf()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAPath#getPath()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAPath#ignore()
   */
  @Override
      ...
      if (pathElement instanceof IntermediateProperty && ((IntermediateProperty) pathElement).isPartOfGroup()) {
        if (groups == null)
          ...
          if (groups.size() != newGroups.size() || !newGroups.containsAll(groups))
            throw new ODataJPAModelException(ODataJPAModelException.MessageKeys.NOT_SUPPORTED_MIXED_PART_OF_GROUP, alias);
        }
      }
    }
