...
import nl.buildforce.sequoia.metadata.core.edm.annotation.EdmDescriptionAssociation.valueAssignment;
...
final class IntermediateDescriptionProperty extends IntermediateSimpleProperty implements JPADescriptionAttribute {
      ...
      if (jpaMember instanceof AnnotatedElement) {
        ...
        if (association != null) {
          ...
          if (descriptionProperty == null)
            ...
            throw new ODataJPAModelException(ODataJPAModelException.MessageKeys.INVALID_DESCRIPTION_PROPERTY, targetEntity.getInternalName(),
  ...
  private JPAPath convertAttributeToPath(final String attribute) throws ODataJPAModelException {
    ...
    if (pathItems.length > 1) {
      ...
      if (nextHop == null)
        throw new ODataJPAModelException(ODataJPAModelException.MessageKeys.PATH_ELEMENT_NOT_FOUND, pathItems[0], attribute);
