...
import nl.buildforce.sequoia.metadata.core.edm.mapper.api.JPAEntitySet;
...
class IntermediateServiceDocument implements JPAServiceDocument {
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAServiceDocument#getAllSchemas()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAServiceDocument#getEdmEntityContainer()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAServiceDocument#getEdmSchemas()
   */
  @Override
   ...
   * @see
   * nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAServiceDocument#getEntity(org.apache.olingo.commons.api.edm.
   * EdmType)
   */
  @Override
   ...
   * @see
   * nl.buildforce.sequoia.metadata.core.edm.mapper.api.JPAServiceDocument#getComplexType(org.apache.olingo.commons.api.edm
   * .EdmComplexType)
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAServiceDocument#getEntity(java.lang.String)
   */
  @Override
   ...
   * @see
   * nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAServiceDocument#getEntitySet(nl.buildforce.sequoia.metadata.core.
   ...
   * @see
   * nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAServiceDocument#getFunction(org.apache.olingo.commons.api.edm.
   * EdmFunction)
   */
  @Override
   ...
   * @see
   * nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAServiceDocument#getAction(org.apache.olingo.commons.api.edm.
   * EdmFunction)
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAServiceDocument#getReferences()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.metadata.core.edm.mapper.impl.JPAServiceDocument#getTerm(org.apache.olingo.commons.api.edm.
   * FullQualifiedName)
   */
  @Override
